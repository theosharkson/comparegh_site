<div class="page-bottom-info">
    <div class="page-bottom-info-inner">
        ...
        <div class="page-bottom-info-content text-center">
            <h1>If you have any questions, comments or concerns, please call the GH-Compare support department
                at (+233) 543-414-719</h1>
            <a class="btn  btn-lg btn-primary-dark" href="tel:+233543414719">
                <i class="icon-mobile"></i> 
                <span class="hide-xs color50">Call Now:</span> 
                (+233) 543-414-719
            </a>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="copy-info text-center">
                        &copy; 2020 GH-Compare. All Rights Reserved.
                    </div>
